...
/**
 * Program Health M3 impacts are read-only views of Recruiting M3 impact artifacts.
 * Consumers must treat results as advisory and non-authoritative per canon.
 */
