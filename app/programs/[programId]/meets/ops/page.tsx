/* File: app/programs/[programId]/meets/ops/page.tsx */
...
export default async function MeetOpsLandingPage({ params }: PageProps) {
      ...
      <div className="grid grid-cols-12 gap-4">
        ...
        <aside className="col-span-12 md:col-span-4">
          <div className="space-y-3">
            <InvestigatePanel title="Ops Blocking Issues" count={0} />
            <InvestigatePanel title="Token Alerts" count={0} />
            <InvestigatePanel title="Live Results Flags" count={0} />
          </div>
        </aside>
        ...
        <main className="col-span-12 md:col-span-8">
          <div className="rounded-md border p-4">
            <h1 className="text-xl font-semibold">Meet Day Ops</h1>
            <p className="mt-1 text-sm text-muted-foreground">
              Select a meet to operate on meet day.
            </p>

            <div className="mt-4 rounded-md border bg-muted/20 p-4 text-sm">
              Stub: this surface will list relevant meets for the program and route into the
              meet-scoped ops workspace.
            </div>
