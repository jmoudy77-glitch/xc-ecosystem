...
export function GlassModalShell({
  ...
  return createPortal(
    <div
      className="fixed inset-0 z-[20000] flex items-center justify-center bg-black/55 backdrop-blur-md px-3 py-4"
      onClick={onClose}
      role="dialog"
      aria-modal="true"
    >
      ...
      <div
        className={`relative z-[20001] flex w-full ${maxWidthClassName} ${heightClassName} flex-col overflow-hidden rounded-xl panel bg-panel-muted/75 backdrop-blur-xl shadow-[0_30px_90px_rgba(0,0,0,0.65)] ring-1 ring-panel`}
