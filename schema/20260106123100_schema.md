...
CREATE TABLE public.meet_entries (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  meet_id uuid NOT NULL,
  athlete_id uuid NOT NULL,
  event_id uuid NOT NULL,
  entry_state USER-DEFINED NOT NULL CHECK (entry_state::text <> '__PLACEHOLDER__'::text),
  created_at timestamp with time zone NOT NULL DEFAULT now(),
  updated_at timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT meet_entries_pkey PRIMARY KEY (id),
  CONSTRAINT meet_entries_meet_id_fkey FOREIGN KEY (meet_id) REFERENCES public.meets(id)
);
CREATE TABLE public.meet_events (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  meet_id uuid NOT NULL,
  event_type USER-DEFINED NOT NULL,
  xc_state USER-DEFINED CHECK (xc_state IS NULL OR xc_state::text <> '__PLACEHOLDER__'::text),
  tf_state USER-DEFINED CHECK (tf_state IS NULL OR tf_state::text <> '__PLACEHOLDER__'::text),
  field_state USER-DEFINED CHECK (field_state IS NULL OR field_state::text <> '__PLACEHOLDER__'::text),
  scheduled_at timestamp with time zone,
  created_at timestamp with time zone NOT NULL DEFAULT now(),
  updated_at timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT meet_events_pkey PRIMARY KEY (id),
  CONSTRAINT meet_events_meet_id_fkey FOREIGN KEY (meet_id) REFERENCES public.meets(id)
);
CREATE TABLE public.meet_participants (
  ...
  join_state USER-DEFINED NOT NULL CHECK (join_state::text <> '__PLACEHOLDER__'::text),
  created_at timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT meet_participants_pkey PRIMARY KEY (id),
  CONSTRAINT meet_participants_meet_id_fkey FOREIGN KEY (meet_id) REFERENCES public.meets(id)
);
CREATE TABLE public.meet_results (
  ...
  publication_state USER-DEFINED NOT NULL CHECK (publication_state::text <> '__PLACEHOLDER__'::text),
  created_at timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT meet_results_pkey PRIMARY KEY (id),
  CONSTRAINT meet_results_meet_id_fkey FOREIGN KEY (meet_id) REFERENCES public.meets(id),
  CONSTRAINT meet_results_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.meet_events(id)
);
CREATE TABLE public.meet_rosters (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  meet_id uuid NOT NULL,
  program_id uuid NOT NULL,
  roster_state USER-DEFINED NOT NULL CHECK (roster_state::text <> '__PLACEHOLDER__'::text),
  locked_at timestamp with time zone,
  created_at timestamp with time zone NOT NULL DEFAULT now(),
  updated_at timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT meet_rosters_pkey PRIMARY KEY (id),
  CONSTRAINT meet_rosters_meet_id_fkey FOREIGN KEY (meet_id) REFERENCES public.meets(id)
);
CREATE TABLE public.meets (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  host_program_id uuid NOT NULL,
  meet_type USER-DEFINED NOT NULL,
  lifecycle_state USER-DEFINED NOT NULL CHECK (lifecycle_state::text <> '__PLACEHOLDER__'::text),
...
CREATE TABLE public.ops_token_audit (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  ops_token_id uuid NOT NULL,
  action text NOT NULL,
  event_id uuid,
  client_fingerprint text,
  created_at timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT ops_token_audit_pkey PRIMARY KEY (id),
  CONSTRAINT ops_token_audit_ops_token_id_fkey FOREIGN KEY (ops_token_id) REFERENCES public.ops_tokens(id),
  CONSTRAINT ops_token_audit_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.meet_events(id)
);
CREATE TABLE public.ops_tokens (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  meet_id uuid NOT NULL,
  token_type USER-DEFINED NOT NULL,
  token_state USER-DEFINED NOT NULL DEFAULT 'ISSUED'::mm_ops_token_state CHECK (token_state::text <> '__PLACEHOLDER__'::text),
  token_hash text NOT NULL,
  scope_event_id uuid,
  expires_at timestamp with time zone NOT NULL,
  revoked_at timestamp with time zone,
  created_at timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT ops_tokens_pkey PRIMARY KEY (id),
  CONSTRAINT ops_tokens_meet_id_fkey FOREIGN KEY (meet_id) REFERENCES public.meets(id),
  CONSTRAINT ops_tokens_scope_event_id_fkey FOREIGN KEY (scope_event_id) REFERENCES public.meet_events(id)
);
...
CREATE TABLE public.recruiting_candidate_impacts (
  ...
  CONSTRAINT recruiting_candidate_impacts_program_id_fkey FOREIGN KEY (program_id) REFERENCES public.programs(id),
  CONSTRAINT recruiting_candidate_impacts_recruit_id_fkey FOREIGN KEY (recruit_id) REFERENCES public.recruits(id),
  CONSTRAINT recruiting_candidate_impacts_capability_node_id_fkey FOREIGN KEY (capability_node_id) REFERENCES public.capability_nodes(id),
  CONSTRAINT recruiting_candidate_impacts_canonical_event_id_fkey FOREIGN KEY (canonical_event_id) REFERENCES public.canonical_events(id)
);
...
CREATE TABLE public.recruiting_slot_assignments (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  program_id uuid NOT NULL,
  sport text NOT NULL DEFAULT 'xc'::text,
  event_group_key text NOT NULL,
  slot_id text NOT NULL,
  athlete_id uuid NOT NULL,
  athlete_type text NOT NULL CHECK (athlete_type = ANY (ARRAY['returning'::text, 'recruit'::text])),
  is_primary boolean NOT NULL DEFAULT false,
  created_at timestamp with time zone NOT NULL DEFAULT now(),
  updated_at timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT recruiting_slot_assignments_pkey PRIMARY KEY (id)
);
