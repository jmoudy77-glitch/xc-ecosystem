...
comment on policy recruiting_state_signals_program_read is
'Allow program members to read recruiting stabilization signals for their program.';

comment on policy recruiting_candidate_impacts_program_read is
'Allow program members to read advisory candidate impact estimates for their program.';

comment on policy ph_absences_program_read is
