-- supabase/migrations/20260109124500_roster_planning_resolve_sport_from_data.sql
...
begin
  ...
  v_sport := public.rpc_roster_planning_normalize_team_sport_v1(v_team_sport);
  ...
  if v_state.is_locked = false and v_state.auto_sync_on_open = true then
    perform public.rpc_roster_planning_sync_from_recruiting_v1(p_team_season_id, v_sport);
  end if;
